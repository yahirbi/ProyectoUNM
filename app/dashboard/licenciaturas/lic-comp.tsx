...
export default function LicenciaturasComponent() {
  ...
  const getIconForLicenciatura = (iconType: string) => {
    switch (iconType) {
      ...
      case 'law':
        return <div className="p-4 bg-green-200 rounded-lg">
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center mb-6">
        {view !== 'licenciaturas' && (
          <button 
            onClick={handleBack}
            className="mr-4 p-1 rounded-full hover:bg-green-100 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {licenciaturasData.map((licenciatura) => (
            <div 
              ...
              className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm hover:shadow-md hover:border-green-300 transition-all cursor-pointer"
            >
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
            <ul className="divide-y divide-gray-200">
              {selectedCatedratico.classes.map((className: string, index: number) => (
                <li key={index} className="p-4 hover:bg-green-50 transition-colors">
